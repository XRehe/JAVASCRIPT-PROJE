...
let sessions = document.getElementById("pomodoro-sessions");
...
function startTimer(timerDisplay) {
  ...
  myInterval = setInterval(() => {
    ...
    if (timeRemaning < 0) {
      ...
      const second = ((timeRemaning % 60000) / 1000).toFixed(0);
      const formattedTime = `${minutes}:${second.toString().padStart(2, "0")}`;
